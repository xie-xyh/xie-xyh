...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:36BCF7,100:8A2BE2&height=220&section=header&text=Yuhang%20Xie&fontSize=56&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=LLM%20%7C%20Agent%20%7C%20RAG%20%7C%20AI%20Application&descAlignY=60&descSize=20" />

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=26&duration=2800&pause=900&color=36BCF7&center=true&vCenter=true&width=900&lines=Building+Reliable+LLM+Agents;RAG+%7C+Multi-Agent+%7C+Context+Engineering;From+Research+Ideas+to+Production-Ready+AI+Systems;Think+%E2%86%92+Act+%E2%86%92+Observe+%E2%86%92+Improve)](https://git.io/typing-svg)

<p>
  <img src="https://komarev.com/ghpvc/?username=xie-xyh&style=for-the-badge&color=blueviolet" />
  <img src="https://img.shields.io/github/followers/xie-xyh?style=for-the-badge&color=36BCF7" />
  <img src="https://img.shields.io/badge/Focus-LLM%20Agents-8A2BE2?style=for-the-badge" />
  <img src="https://img.shields.io/badge/RAG-Hybrid%20Retrieval-blue?style=for-the-badge" />
...
```mermaid
timeline
    title AI / Agent Engineering Timeline

    2024 : Data Product Intern @ HiRain
         : Intelligent Driving Data Platform
         : Visualization, Testing, Data Analysis

    2025 : Coze RAG Assistant
         : Jilin University Graduate Handbook QA Bot
         : RAG, Intent Routing, Knowledge Base

    2025 : HarmonyOS Function Calling Agent
         : Huawei & Nanjing University Competition
         : Ranked 12 / 133

    2026 : DeepSearch Agent
         : Alibaba Cloud Data+AI Global Competition
         : Ranked 4 / 1028

    2026 : AI Agent Intern @ BIGAI
         : Office Agent, VS Code Extension, MCP, PPTAgent
         : Multi-modal Task Evaluation

    2026 : AI Application Engineer Intern @ Xiaohongshu
         : OpenClaw / Seal Agent Harness
         : Long-Context Compression, Observability, Evaluation

    2026 : Industry Research Multi-Agent
         : China Merchants Bank Digital Finance Training Camp
         : Bronze Award
```
...
[![Email](https://img.shields.io/badge/Email-xie__xyh%40foxmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:xie_xyh@foxmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-xie--xyh-181717?style=for-the-badge&logo=github)](https://github.com/xie-xyh)
